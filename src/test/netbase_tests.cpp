...
{
    BOOST_CHECK(TestSplitHost("www.storecoin.org", "www.storecoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.storecoin.org]", "www.storecoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.storecoin.org:80", "www.storecoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.storecoin.org]:80", "www.storecoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:94706", "127.0.0.1", 94706));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:94706", "127.0.0.1", 94706));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:94706", "::ffff:127.0.0.1", 94706));
    BOOST_CHECK(TestSplitHost("[::]:94706", "::", 94706));
    BOOST_CHECK(TestSplitHost("::94706", "::94706", -1));
    BOOST_CHECK(TestSplitHost(":94706", "", 94706));
    BOOST_CHECK(TestSplitHost("[]:94706", "", 94706));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:94706", "127.0.0.1:94706"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:94706", "[::]:94706"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
