...
#ifndef H_STORECOIN_SCRIPT
#define H_STORECOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CStorecoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Storecoin always counted CHECKMULTISIGs
