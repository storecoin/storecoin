...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("storecoin.sipa.be", "seed.storecoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.storecoin.dashjr.org"));
        vSeeds.push_back(CDNSSeedData("storecoinstats.com", "seed.storecoinstats.com"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("storecoin.petertodd.org", "testnet-seed.storecoin.petertodd.org"));
