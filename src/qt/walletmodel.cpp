...
{
    CStorecoinAddress addressParsed(address.toStdString());
...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl *coinControl)
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // User-entered storecoin address / amount:
            ...
            scriptPubKey.SetDestination(CStorecoinAddress(rcp.address.toStdString()).Get());
...
{
    QString strAddress = QString::fromStdString(CStorecoinAddress(address).ToString());
...
void WalletModel::listCoins(std::map<QString, std::vector<COutput> >& mapCoins) const
{
    ...
    BOOST_FOREACH(const COutput& out, vCoins)
    {
        ...
        mapCoins[CStorecoinAddress(address).ToString().c_str()].push_back(out);
    }
}
