...
unlocked to sign the Storecoin-Qt.app bundle.
...
allowing somebody to distribute a Storecoin-Qt.app or storecoin-qt-setup.exe with a valid
...
that the storecoin-qt.exe file inside the installer had not been tampered with.
