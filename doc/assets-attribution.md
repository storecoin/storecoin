The following is a list of assets used in the storecoin source and their proper attribution.
...
* License: MIT
* Site: [https://storecointalk.org/index.php?topic=15276.0](https://storecointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original storecoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/storecoin.icns, src/qt/res/src/storecoin.svg,
	src/qt/res/src/storecoin.ico, src/qt/res/src/storecoin.png,
	src/qt/res/src/storecoin_testnet.png, docs/storecoin_logo_doxygen.png,
