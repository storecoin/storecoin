...
WORKINGDIR="/tmp/storecoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/storecoin/Storecoin/storecoin-0.8.2/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/storecoin/Storecoin/"
VERSIONPREFIX="storecoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'storecoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[storecoin-]<version>-[rc[0-9]] (example: storecoin-0.7.1-rc1)"
   echo "wget output:"
